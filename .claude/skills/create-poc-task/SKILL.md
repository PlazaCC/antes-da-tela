...
1. Update `docs/poc/tasks/summary.md` with new task entry
2. Add to **"Prioridades — tarefas pendentes"** block (P0→P4 order)
3. Add row to **"Status das tasks"** table
4. Add row to **"Estado atual por tela"** table
