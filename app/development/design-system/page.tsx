...
export const metadata: Metadata = {
  ...
  description:
    'Design system showcase and token reference for the Antes da Tela project.',
}

const colors = [
  { label: 'bg/base', value: '#161616' },
  { label: 'bg/surface', value: '#1E1E1E' },
  { label: 'bg/elevated', value: '#262626' },
  { label: 'border/subtle', value: '#343434' },
  { label: 'border/default', value: '#2A2A2A' },
  { label: 'text/primary', value: '#FFF3D2' },
  { label: 'text/secondary', value: '#CAC5B8' },
  { label: 'text/muted', value: '#999383' },
  { label: 'brand/accent', value: '#1C72D7' },
  { label: 'brand/lime', value: '#C8E87A' },
  { label: 'brand/blue', value: '#1C72D7' },
  { label: 'brand/cream', value: '#FFF3D2' },
...
const typography = [
  {
    label: 'Display / Hero',
    value: '72px',
    description: 'Clash Grotesk, 400, 1.06',
  },
  {
    label: 'Heading 1',
    value: '48px',
    description: 'Clash Grotesk, 400, 1.08',
  },
  {
    label: 'Heading 2',
    value: '32px',
    description: 'Clash Grotesk, 400, 1.13',
  },
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-sm text-muted-foreground">
              Showcase the extracted Figma foundations, typography scales, color
              palette and component inventory for the development environment.
            </p>
          </div>
        </div>
      </section>
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="rounded-3xl border border-border bg-surface p-6">
              <p className="font-display text-display-hero text-primary">
                Display / Hero — “Antes da Tela”
              </p>
              <p className="mt-4 font-display text-heading-2 text-foreground">
                Heading 2 sample text for a section title.
              </p>
              <p className="mt-3 text-body-default text-secondary-foreground">
                Body default is used for normal paragraph copy, with good
                readability and consistent spacing in dark mode layouts.
              </p>
              <p className="mt-3 font-mono text-label-mono-default text-text-secondary">
      ...
      <section className="grid gap-4">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Tokens + components identified from the Figma source file.
            </p>
          </CardHeader>
          <CardContent className="grid gap-3">
      ...
      <section className="grid gap-4">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Live previews of the new NavBar and Info components.
            </p>
          </CardHeader>
