...
- Tasks poc-11 a poc-14: **pendentes** (ver `.agents/tasks/review/`)
...
| Task | Arquivo | Status |
|---|---|---|
| Header redesign | `poc-16-header-redesign.md` | pendente |
| Avatar + FollowButton | `poc-17-avatar-followbutton-components.md` | pendente |
| Search Sheet + Filter Page | `review/poc-11-search-filter-sheet.md` | pendente |
...
| SEO/OG meta | `review/poc-12-script-seo-og-meta.md` | pendente |

### P2 — Features e perfil
| Task | Arquivo | Status |
|---|---|---|
| Profile pages (3 telas) | `poc-19-profile-pages.md` | pendente (dep: poc-17) |
| Audio player | `review/poc-13-audio-player.md` | pendente |
| Comment reactions | `review/poc-14-comment-reactions.md` | pendente |
