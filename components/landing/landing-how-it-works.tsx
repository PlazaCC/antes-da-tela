...
const STEPS = [
  ...
  },
  {
    n: '02',
    verb: 'Compartilhe',
    title: 'O público encontra e participa',
  ...
  },
  {
    n: '03',
    verb: 'Acompanhe',
    title: 'Dados que ajudam a contar sua história',
...
export function LandingHowItWorks() {
  ...
  return (
    <section
      id="como-funciona"
      className="border-t border-[rgb(37,37,37)] bg-[radial-gradient(ellipse_at_20%_0%,rgba(28,114,215,0.06),transparent_50%),rgb(14,14,14)] px-[clamp(24px,6vw,80px)] py-[clamp(80px,10vw,120px)]"
    ...
    >
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mb-12 lg:mb-16">
          <h2
            className="land-reveal m-0 mb-6 max-w-[16ch] font-display text-[clamp(36px,5.4vw,80px)] leading-[0.98]"
            data-delay="1"
          >
          ...
          <p
            className="land-reveal max-w-[560px] text-[clamp(15px,1.2vw,18px)] leading-[1.65] text-text-secondary"
            data-delay="2"
          >
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(260px,340px)_1fr]">
          ...
          <div className="flex flex-col gap-1 lg:sticky lg:top-[100px]">
            {STEPS.map((s, i) => (
              ...
              >
                <span
                  className={`font-display text-[42px] leading-none transition-[color_0.3s_ease] ${i === active ? 'text-[hsl(var(--color-brand-accent))]' : 'text-[rgb(107,104,96)]'}`}
                >
                  {s.n}
                </span>
                <div className="flex flex-col gap-1.5">
                  <span className="font-mono text-[10px] uppercase tracking-[0.16em] text-[hsl(var(--color-brand-accent))]">
                    {s.verb}
                  </span>
                  <span
                    className={`font-display text-[clamp(17px,1.5vw,21px)] leading-[1.2] transition-[color_0.3s_ease] ${i === active ? 'text-[hsl(var(--color-text-primary))]' : 'text-[hsl(var(--color-text-secondary))]'}`}
                  >
                    {s.title}
                  </span>
                  {i === active && (
                    <span className="mt-1.5 font-sans text-[13px] leading-[1.55] text-[rgb(107,104,96)]">
                      {s.body}
                    </span>
                  )}
                </div>
            ...
            <div className="flex items-center gap-3.5 border-b border-[rgb(37,37,37)] bg-[rgb(30,30,30)] p-[12px_16px]">
              <div className="flex gap-[6px]">
                {[0, 1, 2].map((i) => (
                  <span
                    key={i}
                    className="h-[9px] w-[9px] rounded-full bg-[rgb(52,52,52)]"
                  />
                ))}
              </div>
              ...
              <span className="rounded-[2px] border border-[rgba(28,114,215,0.4)] px-[8px] py-[4px] font-mono text-[10px] uppercase tracking-[0.16em] text-[hsl(var(--color-brand-accent))]">
                {STEP_LABEL[active]}
              </span>
            </div>
