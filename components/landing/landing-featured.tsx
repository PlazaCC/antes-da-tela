...
function FeaturedCard({
  ...
  return (
    ...
    >
      <article className="land-reveal flex cursor-pointer flex-col rounded-[4px] border border-[rgb(37,37,37)] bg-[rgb(22,22,22)] transition-[transform_0.3s_ease,border-color_0.3s_ease] hover:border-[hsl(var(--color-brand-accent))]">
        <div
        ...
        <div className="flex flex-col gap-3.5 p-4">
          <div className="flex items-center justify-between text-[12px]">
            <span className="font-bold text-[hsl(var(--color-brand-accent))]">
              ★ {rating ?? '—'}
            </span>
            <span className="text-[rgb(107,104,96)]">por {author}</span>
          </div>
          <div className="flex justify-between border-t border-[rgb(37,37,37)] pt-3 font-mono text-[11px] uppercase tracking-[0.12em] text-[hsl(var(--color-text-secondary))] transition-[color_0.2s_ease] hover:text-[hsl(var(--color-brand-accent))]">
...
export function LandingFeatured() {
  ...
  const slides = useMemo(() => {
    ...
    items.push(
      <SwiperSlide key="ver-tudo" className="flex !w-[180px] items-center">
        <Link
          href="/feed"
          className="inline-flex items-center gap-2.5 border-b border-[rgb(37,37,37)] pb-1.5 font-display text-[24px] text-[hsl(var(--color-text-primary))] no-underline transition-[color_0.2s_ease,border-color_0.2s_ease] hover:border-[hsl(var(--color-brand-accent))] hover:text-[hsl(var(--color-brand-accent))]"
        >
          Ver tudo{' '}
          <svg
            viewBox="0 0 24 24"
  ...
  return (
    <section
      id="roteiros"
      className="mx-auto max-w-[1280px] border-t border-[rgb(37,37,37)] py-[clamp(80px,10vw,120px)]"
    >
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between md:gap-8">
            ...
            <div className="land-reveal flex gap-2" data-delay="2">
              <button
                ref={prevRef}
                aria-label="Anterior"
                className="swiper-nav-prev flex h-12 w-12 items-center justify-center rounded-full border border-[rgb(52,52,52)] bg-transparent text-[hsl(var(--color-text-primary))] transition-[background_0.2s_ease,border-color_0.2s_ease,transform_0.2s_ease] hover:-translate-y-[2px] hover:border-[hsl(var(--color-brand-accent))] hover:bg-[hsl(var(--color-brand-accent))]"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
