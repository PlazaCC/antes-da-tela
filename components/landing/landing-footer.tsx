  ...
  return (
    <footer
      ...
      <div className='mx-auto max-w-[1280px]'>
        ...
        {/* main grid */}
        <div className='grid gap-10 mb-12 lg:grid-cols-[1.4fr_repeat(3,1fr)] lg:gap-12'>
        ...
        <div className='mb-5 flex flex-col items-center gap-2'>
          ...
          <a
            ...
            className='text-text-secondary transition-opacity hover:opacity-80'>
            <svg
              width='80'
