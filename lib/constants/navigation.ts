import { LayoutDashboard, BookOpen, Star, Settings, UserCircle2, FileUpIcon } from 'lucide-react'
...
export const NAV_ITEMS = [
  ...
  { id: 'ratings', label: 'Avaliações', href: '/ratings', icon: Star, disabled: true, highlighted: false },
